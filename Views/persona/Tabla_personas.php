...
<section class="mt-3 pt-2 col-12">
    <div class="row sombra mt-3 pt-2 text-cente">
        ...
        <a href="/persona/nuevapersona">
            <button class="btn btn-success" id="" data-toggle="tooltip" title="Registrar Persona"><i
                        class="fas fa-plus"></i> Registrar Persona
            </button>
        </a>

        <a href="/persona/inactivos">
            <button class="btn btn-danger" id="" data-toggle="tooltip" title="Personas Inactivos"><i
                        class="fas fa-arrow-down"></i> Personas inactivos
            </button>
        </a>
        ...
        <div class=" col-12" id="">
            <table class=" table-hover table-condensed table-striped" id="tabladatos" align="left">
                ...
                <tr>
                    ...
                    <td class='tex-center'><span><i class="fa fa-trash fa-lg " aria-hidden="true"></i> Inactivar </span></td>
                </tr>
                </thead>
                <tbody>
                </tbody>
