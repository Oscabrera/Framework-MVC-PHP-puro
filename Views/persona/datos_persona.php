      ...
      <form action="" method="post" id="datos_usuario" >
        ...
        <div class="row m-1 pt-1">
          <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-4 validar">
            <div class="md-form ">
              <input type="text" id="curp" name="curp" class="form-control has-content"  required max-length='18' >
              <label for="curp" >CURP</label>
            </div>
          </div>
          <div class="col-12 col-sm-12 col-md-4 col-lg-6 col-xl-4 validar">
            <div class="md-form ">
              <input type="text" id="fnacimiento" name="fnacimiento" class="form-control has-content" disabled >
        ...
        <div class="row m-1 pt-2">
            <div class="col-12 col-sm-12 col-md-4 col-lg-6 col-xl-4 validar">
              <div class="md-form ">
                <input type="text" id="nombres" name="nombres" class="form-control ecurp has-content nombres " required>
                <label for="nombres" >Nombre</label>
              </div>
            </div>
            <div class="col-12 col-sm-12 col-md-4 col-lg-6 col-xl-4 validar">
              <div class="md-form ">
                <input type="text" id="ape_pat" name="ape_pat" class="form-control ecurp has-content ape_pat " required>
                <label for="ape_pat" >Apellido paterno</label>
              </div>
            </div>
            <div class="col-12 col-sm-12 col-md-4 col-lg-6 col-xl-4 validar">
              <div class="md-form ">
                <input type="text" id="ape_mat" name="ape_mat" class="form-control ecurp has-content ape_mat " required>
